...
distro/live-evm-devel: distro/live-evm-cluster  use/evm/cluster use/evm/devel use/relname use/systemd
	@$(call set,KFLAVOURS,un-def)
	@$(call set,META_SYSTEM_ID,LINUX)
...
distro/live-evm-desktop: distro/live-evm-devel distro/.live-desktop-ru use/live/nodm use/x11/3d-proprietary use/evm/desktop
	@$(call set,KFLAVOURS,un-def)
	@$(call try,HOMEPAGE,http://bsuir.by)
	@$(call try,HOMENAME,BSUIR)
